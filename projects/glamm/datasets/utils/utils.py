...
BOX_QUESTIONS = [
    "Detect and locate the {class_name} in this image.",
    "Identify the {class_name} in this image with a bounding box.",
    "Where is the {class_name} in this image?",
    "Can you locate the {class_name} in this image?",
    "Please find the {class_name} and show its location.",
    "Identify and locate the {class_name} in this image.",
    "Highlight the area containing the {class_name}.",
    "Locate the region where the {class_name} appears.",
    "Identify and box the {class_name} in this image.",
]

BOX_ANSWER_LIST = [
    "It is located at <box>{coords}</box>.",
    "I found the {class_name} at <box>{coords}</box>.",
    "It appears at <box>{coords}</box>.",
    "Here is its location: <box>{coords}</box>.",
    "The bounding box for the {class_name} is <box>{coords}</box>.",
    "The {class_name} is positioned at <box>{coords}</box>.",
    "The {class_name} can be found at <box>{coords}</box>.",
]

BOX_POINT_QUESTIONS = [
    "Detect and locate the {class_name} in this image with its bounding box and key points.",
    "Mark the {class_name} with bounding box and key points.",

    "Where is the {class_name} in this image? Identify and locate it.",
    "Can you locate the {class_name} in this image?",
    
    "Please find the {class_name} and mark its key locations.", 
    "Highlight the {class_name} with bounding box and key points.",
    
    "Locate the region where the {class_name} appears.",
    "Identify and analyze the {class_name} in this image."
]

BOX_POINT_ANSWER_LIST = [
    "It is located at <box>{coords}</box> with key points at <points>{point_coords}</points>.",
    "I found the {class_name} at <box>{coords}</box> and marked points <points>{point_coords}</points>.",
    "It appears at <box>{coords}</box> with distinctive points at <points>{point_coords}</points>.",
    "Here it is: <box>{coords}</box> and key points: <points>{point_coords}</points>.",
    "The {class_name} is at <box>{coords}</box> with marked points <points>{point_coords}</points>.",
    "Found its bounding box at <box>{coords}</box> with representative points <points>{point_coords}</points>.",
    "The {class_name} is at <box>{coords}</box> with key points <points>{point_coords}</points>."
]