...
def video_lisa_collate_fn(instances: Sequence[Dict],
    ...
    for example in instances:
        ...
        if has_bboxes:
            ...
            # if 'bboxes_areas' in example.keys() and example['bboxes_areas'] is not None:
            #     object_bboxes_areas.append(example['bboxes_areas'])
            # if 'bboxes_expression' in example.keys() and example['bboxes_expression'] is not None:
            #     object_bboxes_expressions.append(example['bboxes_expression'])
    ...
    if has_bboxes:
        ...
        # data_dict['bboxes_areas'] = object_bboxes_areas
        # data_dict['bboxes_expressions'] = object_bboxes_expressions
